...
// var Usrdata = document.querySelector(".recipes")
let recipes = [
    {
...
//document.getElementById('recipe').innerHTML = recipes[1].title
// let recCont = [];
// for (var i = 0; i < recipes.length; i++){
//     //document.getElementById('recipe').innerHTML = recipes[i].title;
//     let h1Element = document.createElement('h1');
//     let h2Element = document.createTextNode('h2');
//     let pElement = document.createElement('p');
//     recCont.push(recipes[i].title)

//     let firstText = document.createTextNode(recCont[i])
//     h1Element.appendChild(firstText);
//     let parent = document.querySelector('#recipe');
//     parent.appendChild(h1Element);
//     // console.log(recipes[i].title)
//     // console.log(recipes[i].time)
//     // console.log(recipes[i].calories)
...
document.getElementById("recipe").innerHTML = recipes.map(item => 
    `<div>
    <h1>${item.title}</h1>
    <h3>Time: ${item.time} minutes<h3>
